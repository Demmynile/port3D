        ...
        <div className="grid min-h-[70vh] grid-cols-1  md:grid-cols-2 items-center">
            ...
            <div className="col-start-1 md:row-start-1">
                <h1 className="mb-8 text-[clamp(3rem,20vmin,20rem)] font-extrabold leading-none tracking-tighter">
                    <span className = "block text-slate-300"> {renderLetters("Ade" , "first")} </span>
                    {/* last name */}
                    <span className="-mt-[.2em] block text-slate-500 "> {renderLetters("Techie" , "last")} </span>
                ...
                <span className=" job-title block bg-gradient-to-tr from-yellow-500 via-yellow-200
                 ...
                 text-transparent opacity-0 md:text-4xl">{"Data Professional"}</span>
            </div>
